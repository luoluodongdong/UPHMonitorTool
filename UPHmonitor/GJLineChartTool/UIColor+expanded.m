...
@interface NSColor (NSColor_Undocumented)
- (NSString *)styleString;
@end
#endif // SUPPORTS_UNDOCUMENTED_API

@interface NSColor (NSColor_Expanded_Support)
+ (NSColor *)searchForColorByName:(NSString *)cssColorName;
@end

#pragma mark -

@implementation NSColor (NSColor_Expanded)
...
- (NSColor *)colorByLuminanceMapping {
	...
	return [NSColor colorWithWhite:r*0.2126f + g*0.7152f + b*0.0722f
							 alpha:a];
...
- (NSColor *)colorByMultiplyingByRed:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue alpha:(CGFloat)alpha {
	...
	return [NSColor colorWithRed:MAX(0.0, MIN(1.0, r * red))
...
- (NSColor *)colorByLighteningToRed:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue alpha:(CGFloat)alpha {
	...
	return [NSColor colorWithRed:MAX(r, red)
						   green:MAX(g, green)
							blue:MAX(b, blue)
						   alpha:MAX(a, alpha)];
}
...
- (NSColor *)colorByDarkeningToRed:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue alpha:(CGFloat)alpha {
	...
	return [NSColor colorWithRed:MIN(r, red)
						   green:MIN(g, green)
							blue:MIN(b, blue)
						   alpha:MIN(a, alpha)];
}
...
+ (NSColor *)colorWithString:(NSString *)stringToConvert {
	...
	switch (i) {
		case 2: // monochrome
			color = [NSColor colorWithWhite:c[0] alpha:c[1]];
			break;
		case 4: // RGB
			color = [NSColor colorWithRed:c[0] green:c[1] blue:c[2] alpha:c[3]];
			break;
		default:
			color = nil;
	}
...
+ (NSColor *)randomColor {
    return [NSColor colorWithRed:(arc4random()%256)/256.f
...
+ (NSColor *)colorWithHexString:(NSString *)stringToConvert andAlpha:(CGFloat)alpha{
    NSColor *color = [NSColor colorWithHexString:stringToConvert];
    return [NSColor colorWithRed:color.red green:color.green blue:color.blue alpha:alpha];
}
...
#if SUPPORTS_UNDOCUMENTED_API
@implementation NSColor (NSColor_Undocumented_Expanded)
...
- (NSColor *)rgbColor {
	...
	return [NSColor colorWithRed:red green:green blue:blue alpha:self.alpha];
}
@end
#endif // SUPPORTS_UNDOCUMENTED_API

@implementation NSColor (NSColor_Expanded_Support)
/*
